...
import com.example.demo.Controller.exceptions.NonexistentEntityException;
...
public class UsuariosJpaController implements Serializable {
    ...
    @CrossOrigin(origins = "*")
    @GetMapping ("/login")
    public HashMap<String, String> login (@RequestParam("correo") String correo, @RequestParam ("contrasena")String contrasena){
